...
# ---------------------------------------------------------------------------
# Storage de mídia (fotos dos checklists/relatórios)
# MEDIA_BACKEND=s3 (padrão): MinIO via django-storages — usado no seu PC.
# MEDIA_BACKEND=local: disco do próprio servidor — usado na VPS, pra não
# depender de nenhum registry de imagem Docker externo (MinIO/Bitnami/quay.io
...
if MEDIA_BACKEND == "local":
    ...
    AWS_QUERYSTRING_AUTH = False  # bucket público de leitura (ver ensure_bucket)